...
-- Tiempo de generación: 01-10-2025 a las 18:23:07
...
--
-- Estructura de tabla para la tabla `espinas`
--

CREATE TABLE `espinas` (
  `id_espinas` int(11) NOT NULL,
  `Espinas` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `espinas`
--

INSERT INTO `espinas` (`id_espinas`, `Espinas`) VALUES
(1, 'Geminadas'),
(2, 'Curvas'),
(3, 'Brotadas');
...
INSERT INTO `eventos` (`id_evento`, `evento`) VALUES
(1, 'Hojas brotando'),
(2, 'Hojas brotando pimpollos'),
(3, 'Hojas desplegadas pimpollos'),
(4, 'Pimpollos y flores abiertas'),
(5, 'Flores abiertas'),
(6, 'Flores abiertas y frutos verdes'),
(7, ' Frutos verdes'),
(8, 'Frutos verdes y anaranjados'),
(9, 'Frutos anaranjados'),
(10, 'Hojas desplegadas sin flores ni frutos'),
(11, 'Hojas senescentes');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `eventos_tala`
--

CREATE TABLE `eventos_tala` (
  `id_eventostala` int(11) NOT NULL,
  `id_tala` int(11) NOT NULL,
  `id_evento` int(11) NOT NULL,
  `fecha_creacion` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_evento` date DEFAULT NULL,
  `foto_evento` text DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `fenologia_tala`
--

CREATE TABLE `fenologia_tala` (
  `id_fenologia` int(11) NOT NULL,
  `fecha_creacion` datetime DEFAULT current_timestamp(),
  `id_user` int(11) NOT NULL,
  `Nombre_individuo` text NOT NULL,
  `id_argentinat` varchar(20) NOT NULL,
  `id_especie` int(11) NOT NULL,
  `especie_otro` text DEFAULT NULL,
  `id_provincia` int(11) NOT NULL,
  `id_localidad` int(10) NOT NULL,
  `id_tipo` int(11) NOT NULL,
  `id_origen` int(2) NOT NULL,
  `id_fruto` int(2) NOT NULL,
  `id_espinas` int(3) NOT NULL,
  `foto_espinas` text DEFAULT NULL,
  `Coordenadas` text NOT NULL,
  `luz` int(11) DEFAULT NULL,
  `distancia_edif` text NOT NULL,
  `fecha_foto` date NOT NULL,
  `foto_completo` text NOT NULL,
  `foto_fruto` text NOT NULL,
  `foto_pireno` text NOT NULL,
  `permiso` int(1) NOT NULL COMMENT '1=SI, 2=NO',
  `Sugerencias` text NOT NULL,
  `latitud` double NOT NULL COMMENT 'coordenada en geográficas',
  `longitud` double NOT NULL COMMENT 'coordenada en geográficas'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `frutos` (`id_fruto`, `Fruto`) VALUES
(1, 'Verde'),
(2, 'Mixto'),
(3, 'Naranja');
...
--
-- Estructura de tabla para la tabla `germinacion_tala`
--

CREATE TABLE `germinacion_tala` (
  `id` int(11) NOT NULL,
  `user_id` int(5) NOT NULL,
  `fecha_creacion` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_siembra` date NOT NULL,
  `mes_siembra` int(2) NOT NULL,
  `fecha_germinacion` date NOT NULL,
  `fq_riego` int(1) NOT NULL,
  `n_maceta` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `meses_anio`
--

CREATE TABLE `meses_anio` (
  `id_meses_anio` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `meses_anio`
--

INSERT INTO `meses_anio` (`id_meses_anio`, `Mes`, `mes_numero`, `Anio`) VALUES
(1, 'Enero', 1, 2022),
(2, 'Febrero', 2, 2022),
(3, 'Marzo', 3, 2022),
(4, 'Abril', 4, 2022),
...
(9, 'Septiembre', 9, 2022),
(10, 'Octubre', 10, 2022),
(11, 'Noviembre', 11, 2022),
(12, 'Diciembre', 12, 2022);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `objetivos_vivero`
--

CREATE TABLE `objetivos_vivero` (
  `id` int(2) NOT NULL,
  `Objetivo` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `objetivos_vivero`
--

INSERT INTO `objetivos_vivero` (`id`, `Objetivo`) VALUES
(1, 'Educativo'),
(2, 'Conservación'),
(3, 'Restauración'),
(4, 'Social'),
...
(1, 'NOMBRE DEL PROYECY', '', '', 'NOMBRE INSTITUCION', '');
...
--
-- Estructura de tabla para la tabla `tipo_vivero`
--

CREATE TABLE `tipo_vivero` (
  `id` int(11) NOT NULL,
  `Tipo` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tipo_vivero`
--

INSERT INTO `tipo_vivero` (`id`, `Tipo`) VALUES
(2, 'Comercial'),
(3, 'Áreas protegidas'),
(4, 'Gubernamental/Municipal'),
(5, 'ONG'),
(6, 'Investigación/Divulgación'),
(7, 'Escuelas/Institutos'),
(8, 'Paisajista');
...
CREATE TABLE `users` (
  ...
  `email` varchar(200) NOT NULL,
  `exp_identificacion` int(11) DEFAULT NULL,
  `exp_cultivo` int(11) DEFAULT NULL,
  `password` text NOT NULL,
  `type` tinyint(1) NOT NULL DEFAULT 2 COMMENT '1 = admin, 2 =fenologia, 3=germinacion, 4=fenologia+germinacion',
  `date_created` datetime NOT NULL DEFAULT current_timestamp(),
  `Vivero` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `id_provincia` int(11) DEFAULT NULL,
  `id_localidad` int(11) DEFAULT NULL,
  `Calle` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `Altura` int(10) DEFAULT NULL,
  `provincia_vivero` text DEFAULT NULL,
  `localidad_vivero` text DEFAULT NULL,
  `Contacto` text DEFAULT NULL,
  `Tipo_vivero` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `Objetivo_vivero` text DEFAULT NULL,
  `Sugerencias` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `users`
--
--La contraseña para el usuario de prueba es 1234
INSERT INTO `users` (`id`, `firstname`, `lastname`, `edad`, `Telefono`, `email`, `exp_identificacion`, `exp_cultivo`, `password`, `type`, `date_created`, `Vivero`, `id_provincia`, `id_localidad`, `Calle`, `Altura`, `provincia_vivero`, `localidad_vivero`, `Contacto`, `Tipo_vivero`, `Objetivo_vivero`, `Sugerencias`) VALUES
(1, 'Usuario', 'Prueba', 34, '47674674', 'usuario@prueba.com.ar', 2, 1, '81dc9bdb52d04dc20036dbd8313ed055'), 1, '2020-11-26 10:57:04', 'las flores', 1, 19, 'sada', 55, '', '', '3534534', 'Comercial,Áreas protegidas', 'Restauración,Social', '																																																																																																																							dsffsfs																																																																										'),
...
--
-- Indices de la tabla `espinas`
--
ALTER TABLE `espinas`
  ADD PRIMARY KEY (`id_espinas`);
...
--
-- Indices de la tabla `eventos_tala`
--
ALTER TABLE `eventos_tala`
  ADD PRIMARY KEY (`id_eventostala`);
...
--
-- Indices de la tabla `fenologia_tala`
--
ALTER TABLE `fenologia_tala`
  ADD PRIMARY KEY (`id_fenologia`);
...
--
-- Indices de la tabla `germinacion_tala`
--
ALTER TABLE `germinacion_tala`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `meses_anio`
--
ALTER TABLE `meses_anio`
  ADD PRIMARY KEY (`id_meses_anio`);

--
-- Indices de la tabla `objetivos_vivero`
--
ALTER TABLE `objetivos_vivero`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tipo_vivero`
--
ALTER TABLE `tipo_vivero`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `espinas`
--
ALTER TABLE `espinas`
  MODIFY `id_espinas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `eventos_tala`
--
ALTER TABLE `eventos_tala`
  MODIFY `id_eventostala` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
...
--
-- AUTO_INCREMENT de la tabla `fenologia_tala`
--
ALTER TABLE `fenologia_tala`
  MODIFY `id_fenologia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;

--
-- AUTO_INCREMENT de la tabla `frutos`
--
ALTER TABLE `frutos`
  MODIFY `id_fruto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `germinacion_tala`
--
ALTER TABLE `germinacion_tala`
...
--
-- AUTO_INCREMENT de la tabla `meses_anio`
--
ALTER TABLE `meses_anio`
  MODIFY `id_meses_anio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `objetivos_vivero`
--
ALTER TABLE `objetivos_vivero`
...
--
ALTER TABLE `sesiones`
  MODIFY `id_session` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1166;
...
--
-- AUTO_INCREMENT de la tabla `tipo_vivero`
--
ALTER TABLE `tipo_vivero`
...
--
ALTER TABLE `users`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=281;
COMMIT;
